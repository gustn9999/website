    ...
    if ($('#portfolio-container').length > 0) {
        ...
        if (!isMobile && $('.title-tooltip').length > 0) {
            ...
            $(".portfolio-item").on('mouseleave', function() {
                $circleCursor.css('background-color', 'blue');
...
//Project Slider 3
function project_slider3() {
    if ($('#projectSlider3').length > 0) {
        var testimonialSwiper = new Swiper('#projectSlider3', {
            slidesPerView: 1,
            loop: true,
            navigation: {
                nextEl: '.swiper-button-next',
...
//Project Slider 4
function project_slider4() {
    if ($('#projectSlider4').length > 0) {
        var testimonialSwiper = new Swiper('#projectSlider4', {
            slidesPerView: 1,
            loop: true,
            navigation: {
                nextEl: '.swiper-button-next',
...
//Project Slider 5
function project_slider5() {
    if ($('#projectSlider5').length > 0) {
        var testimonialSwiper = new Swiper('#projectSlider5', {
            slidesPerView: 1,
            loop: true,
            navigation: {
                nextEl: '.swiper-button-next',
...
//Project Slider 6
function project_slider6() {
    if ($('#projectSlider6').length > 0) {
        var testimonialSwiper = new Swiper('#projectSlider6', {
            slidesPerView: 1,
            loop: true,
            navigation: {
                nextEl: '.swiper-button-next',
